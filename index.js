...
// const showcashRadio = document.getElementById('cash');
...
//   }
// });
// showcashRadio.addEventListener('change', function() {
//     if (this.checked) {
//       paymentImage.style.display = 'none';
//     } else {
//       paymentImage.style.display = 'block';
...
function cartToggle(){
    if(cartData.length > 0){
        ...
        document.getElementById('m-cart-plus').classList.toggle('m-cart-toggle')
        document.getElementById('cart-page').classList.toggle('cart-toggle');
        document.getElementById('checkout').cassList.toggle('cart-toggle');
        flag= true;
        console.log(flag)
    }
    else{
